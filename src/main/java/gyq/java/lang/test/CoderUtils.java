 ...
 * @index:http://blog.csdn<a href="http://lib.csdn.net/base/dotnet" class='replace_word' title=".NET知识库" target='_blank' style='color:#df3434;
 *                           font-weight:bold;'>.NET</a>/xxd851116
 */
public class CoderUtils {
	...
	public static void main(String[] args) throws IOException {
		String s = "gdssdfsdfa5656676767675好好学 习！天天向上!@$$%$^&^%&(";
		int[] string2ASCII = string2ASCII(s);
		showIntArray(string2ASCII, " ");
		System.out.println();
		System.out.println(ascii2String(string2ASCII));
